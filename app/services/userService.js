...
* function to find.
*/
userService.find = async ( criteria, projection = {}) => await userModel.find(criteria, projection).lean();

/**
* function to find one.
*/
userService.findOne = async (criteria, projection = NORMAL_PROJECTION) => await userModel
  .findOne(criteria, projection).lean();

/**
* function to update one.
*/
userService.findOneAndUpdate = async (criteria, dataToUpdate, options = { new: true }) => await userModel
  .findOneAndUpdate(criteria, dataToUpdate, options).lean();

/**
* function to update Many.
*/
userService.updateMany = async (criteria, dataToUpdate, projection = {}) => await userModel
...
*/
userService.deleteMany = async (criteria) => await userModel.deleteMany(criteria);
...
*/ userService.count = async (criteria) => await userModel.countDocuments(criteria);
